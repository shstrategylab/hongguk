...
const RELATION_TYPE = {
  천생지: {
    ...
    desc: "윗사람·환경의 전폭적 지원. 귀인 도움과 문서 이득이 따릅니다. 윗사람이나 외부 환경이 알아서 나를 밀어주는 흐름이라, 큰 노력을 들이지 않아도 일이 순조롭게 풀리는 시기입니다. 인사·계약·승인처럼 누군가의 결정이 필요한 일은 이 방향에서 진행하면 한결 수월합니다.",
    badge: "대길",
  },
  지생천: {
    label: "지생천(地生天)",
    ...
    desc: "내가 에너지를 쏟아야 결과가 나옵니다. 과로 주의. 내 쪽에서 먼저 움직이고 자원을 투입해야 비로소 결실이 맺히는 구조로, 가만히 있으면 기회가 그냥 지나갑니다. 단기간에 무리하게 밀어붙이기보다 꾸준히 에너지를 배분해야 번아웃을 피할 수 있습니다.",
    badge: "길",
  },
  천극지: {
    label: "천극지(天剋地)",
    ...
    desc: "외부 압박·상사 불화·문서 손실 위험. 자중하고 때를 기다리세요. 내가 통제할 수 없는 외부 요인(상급자, 제도, 계약 조건 등)이 나를 짓누르는 흐름이라, 정면 돌파보다 일단 한 발 물러서서 충격을 흡수하는 전략이 안전합니다. 이 시기에 새 계약이나 큰 결정을 강행하면 손실로 이어지기 쉽습니다.",
    badge: "흉",
  },
  지극천: {
    label: "지극천(地剋天)",
    ...
    desc: "추진력은 있으나 주변과 마찰. 독단 금물, 협력이 키입니다. 내 추진력과 의지는 강하지만 그만큼 주변 환경·사람들과 부딫히기 쉬운 구조이므로, 혼자 밀고 나가기보다 사전에 의견을 모으고 협조를 구하는 과정이 마찰을 줄여줍니다. 일방적으로 결정을 강행하면 단기적으로는 이겨도 장기적으로 관계에 부담이 남습니다.",
    badge: "보통",
  },
  비화: {
    label: "비화(比和)",
    ...
    desc: "변화 없이 현상 유지. 안정적이나 획기적 발전은 어렵습니다. 위아래의 기운이 서로 같아 부딫힘 없이 평온하게 흘러가는 구조로, 큰 사고나 갈등 없이 무난하게 지나가는 시기입니다. 다만 같은 기운이 정체되어 있는 만큼 새로운 시도나 변화의 동력은 약하니, 안정을 지키는 용도로 활용하는 것이 좋습니다.",
    badge: "중",
  },
};
